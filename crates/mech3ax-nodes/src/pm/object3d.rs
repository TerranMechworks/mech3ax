...
use log::{debug, trace};
use mech3ax_api_types::gamez::nodes::pm::Object3dPm;
use mech3ax_api_types::gamez::nodes::Transformation;
...
pub fn make_variants(object3d: &Object3dPm) -> Result<NodeVariantsPm> {
