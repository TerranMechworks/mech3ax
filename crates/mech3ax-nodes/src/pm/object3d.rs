...
pub fn make_variants(object3d: &Object3dPm) -> NodeVariantsPm {
...
pub fn write(write: &mut CountingWriter<impl Write>, object3d: &Object3dPm) -> Result<()> {
    ...
    write.write_struct(&Object3dPmC {
        flags,
        opacity: 0.0,
        zero008: 0.0,
        zero012: 0.0,
...
pub fn size(object3d: &Object3dPm) -> u32 {
    let parent_size = if object3d.parent.is_some() { 4 } else { 0 };
    Object3dPmC::SIZE + parent_size + 4 * object3d.children.len() as u32
}
