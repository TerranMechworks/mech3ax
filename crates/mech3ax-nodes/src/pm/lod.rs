...
use log::{debug, trace};
use mech3ax_api_types::gamez::nodes::pm::LodPm;
use mech3ax_api_types::gamez::nodes::BoundingBox;
...
pub fn make_variants(lod: &LodPm, mesh_index_is_ptr: bool) -> Result<NodeVariantsPm> {
