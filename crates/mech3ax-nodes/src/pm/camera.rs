...
use log::{debug, trace};
use mech3ax_api_types::nodes::pm::{AreaPartitionPm, Camera};
...
static_assert_size!(CameraPmC, 488);
...
// fn assert_camera(camera: &CameraPmC, offset: u32) -> Result<()> {
...
//     debug!(
//         "Reading camera node data {} (pm, {}) at {}",
//         index,
//         CameraPmC::SIZE,
//         read.offset
//     );
//     let camera: CameraPmC = read.read_struct()?;
//     trace!("{:#?}", camera);
...
//     debug!(
//         "Writing camera node data {} (pm, {}) at {}",
//         index,
//         CameraPmC::SIZE,
//         write.offset
//     );
