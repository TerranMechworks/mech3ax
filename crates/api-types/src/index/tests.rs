...
#[test]
fn from_i16_min() {
    assert_eq!(Index::from_i16(0), Some(Index::MIN));
    assert_eq!(Index::from_i16(0).unwrap().to_i16(), 0i16);
}

#[test]
fn from_i16_max() {
    assert_eq!(Index::from_i16(32766), Some(Index::MAX));
...
#[test]
fn from_i32_min() {
    assert_eq!(Index::from_i32(0), Some(Index::MIN));
    assert_eq!(Index::from_i32(0).unwrap().to_i32(), 0i32);
}

#[test]
fn from_i32_max() {
    assert_eq!(Index::from_i32(32766), Some(Index::MAX));
