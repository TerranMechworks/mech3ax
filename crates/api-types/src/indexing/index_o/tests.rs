use super::{INDEX_MAX, IndexO as Index};

#[test]
fn from_i16_negative() {
    assert_eq!(Index::from_i16(-2), None);
    assert_eq!(Index::from_i16(i16::MIN), None);
}

#[test]
fn from_i16_min() {
    assert_eq!(Index::from_i16(-1), Some(Index::NONE));
...
fn from_i32_negative() {
    assert_eq!(Index::from_i32(-2), None);
    assert_eq!(Index::from_i32(i32::MIN), None);
}

#[test]
fn from_i32_min() {
    assert_eq!(Index::from_i32(-1), Some(Index::NONE));
