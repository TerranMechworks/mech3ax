...
fn assert_lod(lod: &LodPmC, offset: usize) -> Result<Lod> {
    // TODO
    ...
    let field68 = lod.field64 * lod.field64;
    chk!(offset, lod.field68 == field68)?;
    // TODO
    // chk!(offset, lod.field72 == 0.0)?;
    let field76 = lod.field72 * lod.field72;
    chk!(offset, lod.field76 == field76)?;
    chk!(offset, lod.field80 == 1)?;
    // TODO
    chk!(offset, lod.field84 == 0.0)?;
    chk!(offset, lod.field88 == 0.0)?;
