...
fn assert_world(world: &WorldRcC, offset: usize) -> Result<WorldTemp> {
    ...
    // -- sound nodes
    let sound_count = chk!(offset, node_count(world.sound_count))?;
